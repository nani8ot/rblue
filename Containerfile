...
wget https://copr.fedorainfracloud.org/coprs/bzaidan/Hyprland/repo/fedora-"${FEDORA_MAJOR_VERSION}"/bzaidan-Hyprland-fedora-"${FEDORA_MAJOR_VERSION}".repo -O /etc/yum.repos.d/_copr_bzaidan-Hyprland.repo
...
RUN rm -rf \
	...
	rm -f /etc/yum.repos.d/_copr_bzaidan-Hyprland.repo && \
